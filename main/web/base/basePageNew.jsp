...
<link rel="stylesheet" type="text/css" href="<%=path%>/base/_css/uiStyle.css"/>
<link rel="stylesheet" type="text/css" href="<%=path%>/base/_css/metarnetxinjiang.css"/>
<link rel="stylesheet" type="text/css" href="<%=path%>/base/_css/bootstrap.css"/>
<link rel="stylesheet" type="text/css" href="<%=path%>/base/_css/font-awesome.min.css"/>


<!--[if lte IE 9]>
<script type="text/javascript" src="<%=path %>/component/adapter-ie8/html5shiv.js"></script>
<script type="text/javascript" src="<%=path %>/component/adapter-ie8/respond.js"></script>
