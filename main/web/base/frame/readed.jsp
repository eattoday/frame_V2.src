...
<div class="big-title-metar">已阅查询</div>
...
<script type="text/javascript">
    ...
    var dtGridColumns_2_1_2 = [
        ...
        {id: 'readDate', title: '批阅时间', type: 'date', format:'yyyy-MM-dd hh:mm:ss',columnClass: 'text-center'},
    ...
    var dtGridOption_2_1_2 = {
        lang : 'zh-cn',
        ajaxLoad : true,
        loadURL: '<%=path%>/workBaseController.do?method=getReaded',
        exportFileName : '已阅列表',
