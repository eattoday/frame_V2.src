...
if(__areas){
    for(var i in __areas){
        var __area_container = $('<div style="cursor:pointer"></div>');
...
//            }
            if(!document.getElementById('__' + __link_file + '_container') || !__link_dialog_show){
                __link_dialog = $('<div style="display:none;" id="__' + __link_file + '_container" class=""></div>');
...
//                __link_dialog.append(__link_dialog_header);
                __link_dialog.append($('<div class="" id="__' + __link_file+ '_dialog_body"></div>'));
                $('body').append(__link_dialog);


                var area = ['1000px' , '500px'];
                if((area = eval(__link_file + '(\'__' + __link_file+ '_dialog_body\')')) == false){
