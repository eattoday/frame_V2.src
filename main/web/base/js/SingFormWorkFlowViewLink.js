function SingFormWorkFlowViewLink(__link_dialog_body){
...
//    $('#' + __link_dialog_body).load(_PATH + '/base/frame/workFlowView.jsp?processInstID=' + _winParams.processInstID);
    var iframe = $('<iframe frameborder="0" style="width:1200px;height:500px;" src="'+_PATH + '/base/frame/workFlowView.jsp?processInstID=' + _winParams.processInstID+'"></iframe>');
