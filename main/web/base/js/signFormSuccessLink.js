...
//    $('#' + __link_dialog_body).load(_PATH + '/base/page/signForm.jsp?__signFormAction=Y&up=N&__link_dialog_body=' + __link_dialog_body + '&__batchFlag=' + __batchFlag);

    var iframe = $('<iframe id="' + __link_dialog_body
    + '_iframe" frameborder="0" style="width:100%;height:160px;" src="'
    +_PATH + '/base/page/signForm.jsp?__signFormAction=Y&up=N&__link_dialog_body=' + __link_dialog_body + '&__batchFlag='+__batchFlag+'"></iframe>');
