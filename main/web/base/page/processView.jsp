...
<style>
    ...
    .needs-discussion .djs-visual > :nth-child(1) {
        stroke: #1e90ff !important; /* color elements as red */
        fill:#6495ed;
    }
    .diagram-note {
...
<script src="<%=request.getContextPath()%>/component/bpmn-js/bpmn-viewer.js"></script>
<%--<script src="<%=request.getContextPath()%>/component/bpmn-js/bpmn-modeler.min.js"></script>--%>
<script>
    (function(BpmnViewer, $) {
        // create viewer
        ...
        function importXML(xml) {
            ...
            bpmnViewer.importXML(xml, function(err) {
                ...
                overlays.add('UserTask_1', 'note', {
                    position: {
                        bottom: 0,
                        right: 0
                    },
                    html: '<div class="diagram-note"><a href="#">zwwang</a></div>'
                });
                // add marker
                canvas.addMarker('UserTask_1', 'needs-discussion');
                canvas.addMarker('SequenceFlow_1', 'needs-discussion');
//                alert(overlays.registerEvent);
//                eventBus._addListener('item.click' , { priority: 1000, callback: function(e){
//                      alert(123);
//                } });
