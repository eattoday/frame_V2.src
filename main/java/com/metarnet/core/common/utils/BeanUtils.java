...
public class BeanUtils {
    ...
    private static void copyCollection(Object target, String[] effectiveProperties, String[] ignoreProperties,
            ...
            UtilException, ClassNotFoundException, InstantiationException {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (targetValue.contains(sourceArray[i])) {
                ...
                copyProperties(sourceArray[i], tempTarget, effectiveProperties, ignoreProperties,
                        nullBeCopied);
    ...
    // }
    // try {
    // return format.parseActivity(obj);
     ...
     */
    public static void setPropertyValueByPName(Object targetObject, String property,Object... args)throws UtilException{
        try{
    ...
    /*public static String getDefaultComponent(BaseForm baseForm) {
        TableType tableType=baseForm.getClass().getAnnotation(TableType.class);
        if(tableType==null){
            return null;
        }
        return tableType.defaultComponent();
    }*/
}
